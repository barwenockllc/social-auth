...
define([
    ...
    return Component.extend({
        defaults: {
            template: 'Barwenock_SocialAuth/form/element/socialauthShippingStep',
        },
        initialize: function () {
            var self = this;
        ...
        options: {
            twitterLogin: '#twitter-shipping-auth',
            linkedinLogin: '#linkedin-shipping-auth',
            googleLogin: '#google-shipping-auth',
            instagramLogin: '#instagram-shipping-auth',
            fbLogin: '#facebook-shipping-auth',
