define([
    ...
    return Component.extend({
        ...
        options: {
            twitterLogin: '#twitter-billing-auth',
            linkedinLogin: '#linkedin-billing-auth',
            googleLogin: '#google-billing-auth',
            instagramLogin: '#instagram-billing-auth',
            fbLogin: '#facebook-billing-auth',
