define([
    ...
    return Component.extend({
        defaults: {
            template: 'Barwenock_SocialAuth/form/element/socialauthBillingStep',
        },
        initialize: function () {
            var self = this;
        ...
        pageCallCheckout:  socialauthConfig.isCheckoutOn,
        ...
        options: {
            twitterLogin: '#twitter-popup-auth',
            linkedinLogin: '#linkedin-popup-auth',
            googleLogin: '#google-popup-auth',
            instagramLogin: '#instagram-popup-auth',
            fbLogin: '#facebook-popup-auth',
